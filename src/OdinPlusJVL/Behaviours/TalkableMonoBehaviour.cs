...
namespace OdinPlusJVL.Behaviours
{
  public class TalkableMonoBehaviour : MonoBehaviour
  {
    ...
    public TalkableMonoBehaviour(GameObject talker, string name, Animator animator, float textOffset, float textCullDistance, float dialogVisibleTime, float longDialogVisibleTime)
    {
      _animator = animator;
      _name = name;
    ...
    public void Say(string msg, [CanBeNull] string topic, [CanBeNull] string animationTriggerName, bool showName = true, bool longTimeout = false, bool large = false)
    {
